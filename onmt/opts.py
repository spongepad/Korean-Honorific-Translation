...
def model_opts(parser):
    ...
    group.add('--word_vec_size', '-word_vec_size', type=int, default=768,
    ...
    group.add('--rnn_size', '-rnn_size', type=int, default=768,
              help="Size of rnn hidden states. Overwrites "
                   "enc_rnn_size and dec_rnn_size")
    group.add('--enc_rnn_size', '-enc_rnn_size', type=int, default=768,
              help="Size of encoder rnn hidden states. "
                   "Must be equal to dec_rnn_size except for "
                   "speech-to-text.")
    group.add('--dec_rnn_size', '-dec_rnn_size', type=int, default=768,
    ...
    group.add('--state_dim', '-state_dim', type=int, default=768,
...
def translate_opts(parser):
    ...
    group.add('--model', '-model', dest='models', metavar='MODEL',
              nargs='+', type=str, default=["data/model/model.pt"],# required=True,
    ...
    group.add('--log_file', '-log_file', type=str, default="data/log.txt",
              help="Output logs to a file under this path.")
    group.add('--log_file_level', '-log_file_level', type=str,
              action=StoreLoggingLevelAction,
              choices=StoreLoggingLevelAction.CHOICES,
